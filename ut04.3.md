...
> El proceso completo de arranque es lo que comúnmente se conoce como arranque en frio.  Si se lleva a cabo obviando pasos (como al reiniciar mediante Ctrl+Alt+Supr en ciertos SO) se realiza un arranque en caliente, que partirá desde el punto 3 anterior.
...
### Carga del gestor de arranque (Boot Manager)
