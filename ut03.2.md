# UT3.2 Almacenamiento en red local y en la nube
...
Comparativa entre los dos tipos almacenamiento en la nube:

| **Criterio**      | **Nube Pública**                                                                                                                                                                                     | **Nube Privada**                                                                                                                                                                                                      |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Definición**    | Servicio en la nube al que pueden acceder varias personas autorizadas a través de Internet. Los datos se guardan en servidores del proveedor (por ejemplo, Google Drive, OneDrive, Dropbox, iCloud). | Servicio diseñado para una sola persona, empresa u organización. Puede estar en sus propias instalaciones (*on-premise*) o en un servidor externo dedicado (por ejemplo, Amazon S3, OwnCloud, Oracle Cloud Platform). |
| **Escalabilidad** | Muy alta. Es fácil aumentar o reducir el espacio o los recursos según las necesidades.                                                                                                               | Limitada. Depende del hardware disponible en la empresa o del servidor contratado.                                                                                                                                    |
| **Seguridad**     | Buena, pero depende del proveedor del servicio y de sus medidas de seguridad.                                                                                                                        | Muy alta, ya que los datos están bajo el control directo del usuario o de la empresa.                                                                                                                                 |
| **Rendimiento**   | Medio. Depende de la conexión a Internet y del tráfico del servicio.                                                                                                                                 | Alto. Al estar controlado por la empresa o en servidores dedicados, suele ser más rápido.                                                                                                                             |
| **Confiabilidad** | Media. Si hay problemas con Internet o con el proveedor, puede afectar al acceso.                                                                                                                    | Alta. Los equipos están bajo control directo y se puede garantizar mejor la disponibilidad.                                                                                                                           |
| **Coste**         | Bajo. Se paga por uso y no requiere comprar ni mantener servidores propios.                                                                                                                          | Más alto. Requiere invertir en equipos, espacio, energía y mantenimiento.                                                                                                                                             |
## Cloud Computing
